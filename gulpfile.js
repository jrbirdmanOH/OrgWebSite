...
const jsPaths = [
        ...
        {
            dest: 'assets/js/contactusform.js',
            src: [
                'src/assets/js/contactusform.js'                
            ]
        },
        {
 ...
 * Run dev server
 */
gulp.task('serve', gulp.series('clear_build_dir', 'assets', 'styles', 'scripts', 'html', 'favicon', function () {
    server.init({
        server: {
            baseDir: destDir,
            routes: {
...
}, 'clear_build_dir', 'assets', 'styles', 'scripts', 'favicon', 'html'));
